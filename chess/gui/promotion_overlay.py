...
class PromotionOverlay:
    ...
    def __init__(self, layout: Layout):
        self.promotion_overlay_sprites = promotion_sprites_generator(layout, self.white_promotion_batch, self.black_promotion_batch, self.background_group, self.promotion_group)
